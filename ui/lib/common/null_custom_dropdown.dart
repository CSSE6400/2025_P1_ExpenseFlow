...
class NullableCustomDropdown<T> extends StatefulWidget {
  final T? selected;
  ...
  @override
  State<NullableCustomDropdown<T>> createState() =>
      _NullableCustomDropdownState<T>();
}

class _NullableCustomDropdownState<T> extends State<NullableCustomDropdown<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final label = widget.labelBuilder(widget.selected);
          ...
          children: [
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.roboto(
                  color:
                      (widget.selected == null || label.isEmpty)
                          ? hintColor
                          : labelColor,
                  fontSize: ps.scaleText(16),
                ),
